...
describe("Number of players is chosen correctly", () => {
  ...
  it("isValidNumPlayersChoice returns true", () => {
    ...
    const result1 = isValidNumPlayersChoice(input1);
    const result2 = isValidNumPlayersChoice(input2);
  ...
  it("isValidNumPlayersChoice returns false", () => {
    ...
    const result1 = isValidNumPlayersChoice(input1);
    const result2 = isValidNumPlayersChoice(input2);
    const result3 = isValidNumPlayersChoice(input3);
  ...
  it("getNumPlayersChoice returns true", async () => {
    ...
    const result = await getNumPlayersChoice();
