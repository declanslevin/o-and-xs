class Game {
  ...
  setNextPlayer(player) {
    ...
    const playerArray = [player, this.players[player].name];
    this.players.O._sendNextPlayerToBrowser(playerArray);
    this.players.X._sendNextPlayerToBrowser(playerArray);
    // Add send to browser?
  }
  setWinner(team) {
    this.winner = team;
  ...
  announce(messageObj) {
    this.players.O.announce(messageObj);
    this.players.X.announce(messageObj);
  }
}
